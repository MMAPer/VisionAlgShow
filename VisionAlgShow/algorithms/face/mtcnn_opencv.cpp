...
//    PNet_ = cv::dnn::readNetFromCaffe(proto_model_dir + "/det1.prototxt", proto_model_dir + "/det1_half.caffemodel");
    PNet_ = cv::dnn::readNetFromCaffe(proto_model_dir + "/det1-half.prototxt", proto_model_dir + "/det1-half.caffemodel");
    RNet_ = cv::dnn::readNetFromCaffe(proto_model_dir + "/det2-half.prototxt", proto_model_dir + "/det2-half.caffemodel");
...
int main00(int argc, char **argv)
{
    ...
    MTCNN detector("/home/mmap/face/MTCNNTest/model");
    string name_list[1] = {
        "/home/mmap/face/MTCNNTest/images/test.jpg",
	};
